...
import com.shirly.apm29.jkdofficekt.model.bean.Bean
...
import com.shirly.apm29.jkdofficekt.model.bean.LoginResult
...
interface Api {
    ...
    @FormUrlEncoded
    @POST("v1/user/login")
    fun login(@Field("username")username: String,@Field("password") pwd: String): Observable<Bean<LoginResult>>
}
